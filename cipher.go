...
// Encrypt will take in a key and plaintext and return a hex encrypted version of the plaintext.
...
// Decrypt will take in a key and a cipherHex (hexed representation of the ciphertext) and decrypt it.
// This code is based on the standard library examples at:
